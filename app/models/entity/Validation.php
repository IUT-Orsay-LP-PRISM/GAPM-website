...
class Validation{
    ...
    protected static $inscriptionDemandeurFonctions ; // initialisé avec Validation::init()
    protected static $inscriptionIntervenantFonctions ; // initialisé avec Validation::init()
    protected static $connexionDemandeurFonctions ; // initialisé avec Validation::init()
    ...
    public static function verifierNom(){
        if(isset($_POST["nom"]) && $_POST["nom"] != ""){
            return preg_match('/^[A-Za-z][A-Za-z ]{0,49}$/', $_POST['nom']);
        }
        return false;
    }
    ...
    public static function verifierFormulaire($arrayFonctions){
        ...
        for($i = 0; $i < count($errorMessagesReturn); $i++){
            $errorMessagesReturn[$i] = 
            call_user_func($arrayFonctions[$i[0]]) ? NULL : $arrayFonctions[$i][1];
        }
    ...
    */
    ...
    static function init(){
        ...
        Validation::$inscriptionDemandeurFonctions = array(
            array('Validation::verifierPrenom', self::$errorMessagesArray[0]),
            array('Validation::verifierNom', static::$errorMessagesArray[1]),
            array('Validation::verifierEmail', static::$errorMessagesArray[2]),
            array('Validation::verifierDateNaissance', static::$errorMessagesArray[3]),
            array('Validation::verifierAdresse', static::$errorMessagesArray[4]),
            array('Validation::verifierVille', static::$errorMessagesArray[5]),
            array('Validation::verifierSexe', static::$errorMessagesArray[6]),
            array('Validation::verifierMdp', static::$errorMessagesArray[7]),
            array('Validation::verifierNumeroTelephone', static::$errorMessagesArray[8])
        );
        ...
        Validation::$inscriptionIntervenantFonctions = array(
            ...
            array('Validation::verifierMdp', static::$errorMessagesArray[7]),
            array('Validation::verifierNumeroTelephone', static::$errorMessagesArray[8]),
            array('Validation::verifierSpecialites', static::$errorMessagesArray[10]),
            array('Validation::verifierAdresse', static::$errorMessagesArray[4]), // AdressePro
            array('Validation::verifierVille', static::$errorMessagesArray[5]) // VillePro
        );

<header class="header">
    <nav class="header__nav transparent">
        ...
        <ul class="header__menu menu-right">
            <li class="menu-item"><button id="btn-connexion" type="button" class="btn btn-primary-nb">
                    <?php include "assets/svg/user.svg" ?>&nbsp;Se
                    connecter
                </button></li>
            <li class="menu-item"><button id="btn-inscription" type="button" class="btn btn-secondary-nb">

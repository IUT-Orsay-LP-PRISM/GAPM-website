...
<?= \App\Views\Includes\Includes::getHeader("transparent"); ?>
                ...
                <form method="get">
                    ...
                    <div class="hp__banner-inputs-list">
                        <div class="input-container">
                            ...
                            <input id="name-query" class="input" type="text" name="s_name" required/>
                            <label class="label" for="name-query">Nom, spécialité</label>
                        </div>
                        <div class="input-container">
                            <i class="icon icon-fi-rr-location-alt"></i>
                            <input id="city-query" class="input" name="s_city" type="text" required/>
...
<?= \App\Views\Includes\Includes::getFooter() ?>
